...
from app.bootstrap import build_section_chunked_search_pipeline, load_base_test_samples
...
def main():
    ...
    predicted_ids = [
        ...
        for test_sample in tqdm(
            test_samples,
            desc="Generating section chunked answers",
            unit="query",
        )
    ]
    ...
    answers_dir = ANSWERS_DIR / "section_chunked_answers"
