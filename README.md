...
```text
src/runs/20260720_210403_base/metrics.json
src/runs/20260720_161107_chunked_body/metrics.json
src/runs/20260720_032002_section_chunked/metrics.json
```

Значения округлены до 4 знаков после запятой.

| Прогон | Схема | Параметры финального поиска | `recall@10` | `map@10` | `candidate_recall@50` |
|---|---|---|---:|---:|---:|
| `20260720_210403_base` | base | `candidate_limit=50`, `prefetch_limit=100`, `final_limit=10` | `0.6145` | `0.3949` | `0.8362` |
| `20260720_161107_chunked_body` | chunked_body | `candidate_limit=50`, `prefetch_limit=100`, `final_limit=10` | `0.8038` | `0.4930` | `0.8768` |
| `20260720_032002_section_chunked` | section_chunked | `candidate_limit=150`, `prefetch_limit=200`, `final_limit=10` | `0.8242` | `0.4985` | - |

Лучший результат среди сохранённых запусков показывает `section_chunked`: `recall@10 = 0.8242`, `map@10 = 0.4985`. Для этого прогона `candidate_recall@50` в `metrics.json` не сохранялся.
